...
/// Sentinel for nullable [copyWith] fields so `null` can be passed explicitly.
const _unset = Object();
...
class NativeVideoPlayerState {
  ...
  NativeVideoPlayerState copyWith({
    ...
    Object? airPlayDeviceName = _unset,
  }) {
    return NativeVideoPlayerState(
      ...
      airPlayDeviceName: airPlayDeviceName == _unset
          ? this.airPlayDeviceName
          : airPlayDeviceName as String?,
    );
  }
